export const zh = {
    ...
    // Empty Home Pg
    'no-apps-title': '没有胶囊',
    'no-apps-message': '你可以从你的联系人或社交网络上找到elastOS胶囊来浏览。你对elastOS生态系统探索得越多，你就会发现更多的胶囊。',
    'open-our-app': '你可以打开',
    'open-our-app2': '你可以打开',
    'identity-demo': '身份演示',
    ...
    'introduction-0': '在elastOS中，您将对旧互联网有新的理解。这意味着您可以自由浏览分散的应用程序，管理独特的身份，并在网络受限的安全的沙箱环境中拥有自己的加密钱包。',
    'continue': '继续',
